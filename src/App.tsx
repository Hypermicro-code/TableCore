export const SRC_APP_TSX = `import React, { useState } from 'react'
...
<small style={{ color: 'var(--muted)' }}>Tips: Ctrl/Cmd+[ og Ctrl/Cmd+] for innrykk/utrykk. Dobbeltklikk for redigering. Dra kolonner/rader for å flytte.</small>
</div>
